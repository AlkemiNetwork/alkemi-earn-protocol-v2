...
import "./AlkemiVerifiedStorage.sol";
...
contract AlkemiEarnVerified is 
SafeToken, 
ProtocolUtils, 
AlkemiVerifiedStorage,
AlkemiVerifiedInterface {
     ...
     */
    address[] private collateralMarkets;
    ...
    modifier onlyCustomerWithKYC() {
        require(customersWithKYC[msg.sender], Error.NOT_A_KYC_CUSTOMER);
        _;
    }
    ...
    function _changeCustomerKYC(address customer, bool newStatus) public {
        require(KYCAdmins[msg.sender], Error.NOT_A_KYC_ADMIN);
    ...
    function _adminFunctions(
        ...
        require(wethContractAddress != address(0),Error.ADDRESS_CANNOT_BE_0X00);
     ...
     */
    function supplyEther(uint256 etherAmount) internal returns (bool) {
    ...
    {   
        ...
        if (asset != wethAddress) {
            ...
            if (msg.value == amount) {
                supplyEther(localResults.repayAmount);
                //Repay excess funds
    ...
    function revertIfError(bool success) internal pure {
        require(success, Error.INTERNAL_EXCEPTION);
    }
}